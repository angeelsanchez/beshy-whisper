...
import type { InitiativeChatMessage as ChatMessage } from '@/types/initiative';

interface InitiativeChatMessageProps {
...
export default function InitiativeChatMessage({
  message,
  isOwnMessage,
  isDay,
  showHeader,
}: InitiativeChatMessageProps): React.ReactElement {
  const displayName = message.user_name ?? message.user_alias ?? 'Anónimo';
