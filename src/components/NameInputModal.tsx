...
export default function NameInputModal({ onClose }: NameInputModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className={`rounded-lg shadow-lg max-w-md w-full p-6 transition-all duration-300 ${
        isDay ? 'bg-[#F5F0E1] text-[#4A2E1B]' : 'bg-[#2D1E1A] text-[#F5F0E1]'
      }`}>
        <h2 className="text-xl font-bold mb-6">Completa tu perfil</h2>
        
        <div className="mb-6">
          <p className="text-sm font-medium mb-1 opacity-80">Tu identificador único</p>
