...
export const PASSWORD_RULES = [
  ...
  { label: 'Una letra mayuscula', regex: /[A-Z]/ },
  { label: 'Una letra minuscula', regex: /[a-z]/ },
  { label: 'Un numero', regex: /[0-9]/ },
  { label: 'Un caracter especial', regex: /[^A-Za-z0-9]/ },
] as const;

export const passwordSchema = z
  .string()
  .min(PASSWORD_MIN_LENGTH, 'La contrasena debe tener al menos 8 caracteres')
  .max(PASSWORD_MAX_LENGTH, 'La contrasena no puede exceder 128 caracteres')
