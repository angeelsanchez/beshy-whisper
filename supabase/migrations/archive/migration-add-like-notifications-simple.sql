-- Migration to add like notifications functionality for BESHY Whisper (Simplified Version)
...
-- Simplified function to create like notification record only
...
BEGIN
  ...
  -- Insert notification record - this will be picked up by our webhook
